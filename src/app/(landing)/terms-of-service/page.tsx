    ...
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <article className="prose prose-slate md:col-span-3 bg-white p-8 ">
          ...
          <section id="intro">
            <p>
              Welcome to <strong>Islands</strong> ("the App", "we", "us",
              "our"). These Terms of Service ("Terms") govern your access to and
              use of Islands' mobile and web applications, services, and
              content. By creating an account or using the App you agree to
              these Terms.
            </p>
          </section>
          ...
          <section id="ai">
            ...
            <p>
              ...
              intelligence. These outputs are provided "as-is" for entertainment
              and motivation and may not always be unique or error-free.
            </p>
          </section>
